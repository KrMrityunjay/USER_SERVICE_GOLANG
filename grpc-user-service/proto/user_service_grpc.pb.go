...
type UserServiceClient interface {
	GetUserDetails(ctx context.Context, in *UserIdRequest, opts ...grpc.CallOption) (*UserDetailsResponse, error)
	GetUsersByIds(ctx context.Context, in *UserIdsRequest, opts ...grpc.CallOption) (*UsersDetailsResponse, error)
	SearchUsers(ctx context.Context, in *SearchRequest, opts ...grpc.CallOption) (*UsersDetailsResponse, error)
}
...
func (c *userServiceClient) GetUserDetails(ctx context.Context, in *UserIdRequest, opts ...grpc.CallOption) (*UserDetailsResponse, error) {
...
func (c *userServiceClient) GetUsersByIds(ctx context.Context, in *UserIdsRequest, opts ...grpc.CallOption) (*UsersDetailsResponse, error) {
	out := new(UsersDetailsResponse)
...
func (c *userServiceClient) SearchUsers(ctx context.Context, in *SearchRequest, opts ...grpc.CallOption) (*UsersDetailsResponse, error) {
	out := new(UsersDetailsResponse)
...
type UserServiceServer interface {
	GetUserDetails(context.Context, *UserIdRequest) (*UserDetailsResponse, error)
	GetUsersByIds(context.Context, *UserIdsRequest) (*UsersDetailsResponse, error)
	SearchUsers(context.Context, *SearchRequest) (*UsersDetailsResponse, error)
...
func (UnimplementedUserServiceServer) GetUserDetails(context.Context, *UserIdRequest) (*UserDetailsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetUserDetails not implemented")
}
func (UnimplementedUserServiceServer) GetUsersByIds(context.Context, *UserIdsRequest) (*UsersDetailsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetUsersByIds not implemented")
}
func (UnimplementedUserServiceServer) SearchUsers(context.Context, *SearchRequest) (*UsersDetailsResponse, error) {
